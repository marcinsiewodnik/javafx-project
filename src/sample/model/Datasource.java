...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\java-databases\\" + DB_NAME;
...
//    Using PreparedStatemets -> it protects us from injections attact and it is faster to perform
    ...
    public List<Album> queryAlbumsForArtist(int id){
...
//        Creating a transaction, this operation consists of suboperations, and it has to be atomic
